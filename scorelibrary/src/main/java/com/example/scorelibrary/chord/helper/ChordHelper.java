package com.example.scorelibrary.chord.helper;

import com.example.scorelibrary.chord.symbol.Chord;
import com.example.scorelibrary.chord.symbol.ChordLibrary;
import com.example.scorelibrary.chord.symbol.Position;
import com.example.scorelibrary.utils.MLog;
...
public class ChordHelper {
    ...
    private static void increaseEveryFretsByOne(Chord c) {
        MLog.d("Increase: fret before:" + Arrays.toString(c.frets));
